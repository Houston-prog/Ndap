        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <div className="relative bg-neutral-900 border border-neutral-800 w-full max-w-4xl max-h-[90vh] overflow-y-auto rounded-3xl shadow-2xl flex flex-col md:flex-row animate-fade-in">
                ...
                <div className="md:w-1/2 p-8">
                    <span className="text-orange-500 font-bold uppercase tracking-wider text-xs">{property.type}</span>
                    <h2 className="text-3xl font-bold text-white mt-2 mb-4 font-display">{property.title}</h2>
                    <p className="text-2xl text-white font-bold mb-6">${new Intl.NumberFormat().format(property.price)}</p>
                    ...
                    <div className="grid grid-cols-3 gap-4 mb-8">
                        <div className="text-center p-3 bg-neutral-800 rounded-lg">
                            ...
                            <div className="text-neutral-500 text-[10px] uppercase">Chambres</div>
                        </div>
                        <div className="text-center p-3 bg-neutral-800 rounded-lg">
                            <div className="text-white font-bold">{property.bathrooms}</div>
                            <div className="text-neutral-500 text-[10px] uppercase">Salles de bain</div>
                        </div>
                        <div className="text-center p-3 bg-neutral-800 rounded-lg">
                            <div className="text-white font-bold">{property.area}</div>
                            <div className="text-neutral-500 text-[10px] uppercase">m²</div>
                        </div>
                    </div>
